...
print(localtime)
while localtime[8]+localtime[9]=="09" and localtime[11]+localtime[12]=="18" and localtime[14]+localtime[15]=="00": #runs the script forever localtime8 and 9 is the date, while 11 12 is the hour of the day adn 14 15 is the minutes
    j=True
    while localtime[14]+localtime[15]=="00" or localtime[14]+localtime[15]=="01" or localtime[14]+localtime[15]=="02" or localtime[14]+localtime[15]=="03" or localtime[14]+localtime[15]=="04" or localtime[14]+localtime[15]=="05":
